...
try {
  ...
  console.log(`   PostgreSQL: ${result[0].postgresql_version.split(' ')[0]} ${result[0].postgresql_version.split(' ')[1]}`);
  
  // Check if tables exist
  console.log("\n🏗️  Checking database schema...");
  
  const expectedTables = ['schools', 'users', 'classes', 'subjects', 'pupils', 'parents', 'pupil_parents', 'attendance', 'notifications', 'audit_logs', 'marks'];

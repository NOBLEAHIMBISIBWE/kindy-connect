...
function Landing() {
  ...
  const submitReg = async () => {
    if (!reg.name || !reg.email || !reg.phone || !reg.password)
        ...
        <Dialog open={regOpen} onOpenChange={setRegOpen}>
          ...
          <DialogContent>
            ...
            <p className="text-sm text-muted-foreground">
              Register as an admin or teacher. All registrations require admin approval before
              login.
            </p>
            ...
            <DialogFooter>
              <Button onClick={submitReg}>Submit registration</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </header>
        ...
        <Card className="border-0 shadow-xl rounded-3xl overflow-hidden">
          <CardContent className="p-7">
            ...
            <p className="text-sm text-muted-foreground mb-5">
              Only pre-assigned, verified users can sign in.
            </p>
            <div className="space-y-3 mt-4">
              ...
              <p className="text-xs text-muted-foreground text-center">
                Demo: super@kinder.app / super123 · admin@kinder.app / admin123 · grace@kinder.app /
                grace123
              </p>
            </div>
          </CardContent>
